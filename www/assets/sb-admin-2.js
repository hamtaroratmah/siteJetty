...
var Main = function () {
    ...
    var runPanelScroll = function () {
        if ($(".panel-scroll").length && $('.panel-scroll').perfectScrollbar) {
...
/*        $('.main-navigation-menu li.active').addClass('open');
    ...
    if ($('.drop-down-wrapper').perfectScrollbar) {
    ...
    $('.navbar-tools .dropdown').on('shown.bs.dropdown', function () {
    	if ($(this).perfectScrollbar) {
    		...
    		$(this).find('.drop-down-wrapper').scrollTop(0);
    	}
    });
    ...
    return {
        ...
        runContainerHeight:runContainerHeight
    };
}();